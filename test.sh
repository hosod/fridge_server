...
-d '{"foods":[{"expiration_date":"2020/08/05", "quantity":1.5, "fridge_id":1,"food_type_id":7}, {"expiration_date":"2020/07/28", "quantity":300, "fridge_id":1,"food_type_id":6}]}' \
localhost:8000/contents
